...
export default function EventInstance({Event} : EventProps)
{
    ...
    return (<>
        <div className="flex flex-row bg-[#272626] w-[50vw] max-[850px]:h-[22vh] max-[600px]:w-[90vw] rounded-lg items-center" onClick={() => { mainDispatch(SetCurrentEvent(Event)); setClicked(true); }}>
