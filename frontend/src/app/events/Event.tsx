...
export default function EventInstance({Event} : EventProps)
{
    ...
    return (<>
        <div className="flex flex-row bg-[#272626] h-[20vh] w-[50vw] max-[600px]:w-[90vw] rounded-lg items-center">
            ...
            <div className={"flex flex-col self-start mt-2 gap-3 max-[600px]:gap-0 text-sm"}>
                <a className={"text-xl font-bold hover:text-lang-orange max-[600px]:text-lg"} onClick={() => { mainDispatch(SetCurrentEvent(Event)); setClicked(true); }}>{Event.Title}</a>
