...
export default function EventInstance({ Event} : EventProps) {
    ...
    return (<>
        ...
        <Dialog>
                <Card >
                    <CardContent className=" bg-body-gray border-orange-500">
                        <DialogTrigger asChild>

                            <div className="flex flex-col bg-transparent  items-center justify-center" onClick={() => { mainDispatch(SetCurrentEvent(Event)); setClicked(true); }}>
