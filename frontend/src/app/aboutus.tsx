...
const AboutUsSection = function(){
    ...
    return(
        ...
        <div className="flex flex-col w-screen h-52 bg-body-gray items-center justify-center gap-8" >
            <div className="w-4/5 h-fit  flex flex-row justify-between align-baseline">
                <h1 className="w-fit text-3xl font-bold">About Us</h1>
                <a className="w-fit h-fit hover:text-lang-orange" href="./about/page.tsx">learn more about us</a>
            </div>
